...
def make_teleoperator_from_config(config: TeleoperatorConfig) -> "Teleoperator":
    ...
    elif config.type == "keyboard_piper_joint":
        from .keyboard_piper import KeyboardPiperJointTeleop

        return KeyboardPiperJointTeleop(config)
    elif config.type == "keyboard_piper_ee":
        from .keyboard_piper import KeyboardPiperEndEffectorTeleop

        return KeyboardPiperEndEffectorTeleop(config)
